...
class DocumentaryViewVideos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		DocumentaryHelper::addSubmenu('videos');
	...
	protected function addToolbar()
	{
		...
		$canDo	= DocumentaryHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_DOCUMENTARY_TITLE_VIDEOS'), 'videos.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_documentary');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_documentary&view=videos');
