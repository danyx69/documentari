...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		...
		<div class="clearbreak"></div>
		<div id="jsn-body" class="<?php echo ($this->countModules('content-top-over') > 0)?' jsn-hascontenttopover':'' ?><?php echo ($this->countModules('promo') > 0)?' jsn-haspromo':'' ?><?php echo ($this->countModules('promo-left') > 0)?' jsn-haspromo':'' ?><?php echo ($this->countModules('promo-right') > 0)?' jsn-haspromo':'' ?><?php echo ($this->countModules('content-top') > 0)?' jsn-hascontenttop':'' ?>">
			<div id="jsn-body-inner">
			<?php
				/*====== Show modules in content top area ======*/
				if ($this->helper->countPositions('promo-left', 'promo', 'promo-right', 'content-top', 'content-top-over')) {
			?>
				<?php
					/*====== Show modules in position "content-top-over" ======*/
					if ($this->countModules('content-top-over') > 0) {
				?>
					<div id="jsn-content-top-over" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $this->countModules('content-top-over'); ?>">
						<div id="jsn-pos-content-top-over">
							<jdoc:include type="modules" name="content-top-over" style="jsnmodule" />
							<div class="clearbreak"></div>
						</div>
					</div>
					<div class="clearbreak"></div>
							...
							<div id="jsn-centercol">
								<div id="jsn-centercol_inner">
									...
									<div id="jsn-mainbody-content" class="<?php echo (($this->hasInnerLeft)?'jsn-hasinnerleft ':'') ?><?php echo (($this->hasInnerRight)?'jsn-hasinnerright ':'') ?><?php echo ($this->countModules('mainbody-top') > 0)?' jsn-hasmainbodytop':'' ?><?php echo ($this->countModules('mainbody-bottom') > 0)?' jsn-hasmainbodybottom':'' ?><?php echo ($this->showFrontpage)?' jsn-hasmainbody':'' ?>">
										<div id="mainbody-content-inner1"><div id="mainbody-content-inner2"><div id="mainbody-content-inner3"><div id="mainbody-content-inner4" class="<?php echo ($this->countModules('mainbody-top') > 0)?' jsn-hasmainbodytop':'' ?><?php echo ($this->countModules('mainbody-bottom') > 0)?' jsn-hasmainbodybottom':'' ?><?php echo ($this->showFrontpage)?' jsn-hasmainbody':'' ?>">
											<div id="mainbody-content-inner">
												...
												?>
												<div id="jsn-pos-mainbody-bottom" class="jsn-modulescontainer jsn-modulescontainer<?php echo $this->countModules('mainbody-bottom'); ?>">
